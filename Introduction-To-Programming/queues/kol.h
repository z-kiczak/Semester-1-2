...
struct interesant {
    int num, k; 
    //num - numerek interesanta, k - numer kolejki w której stoi (gwarantowana poprawność tylko dla pierwszej i ostatniej osoby w kolejce w danym momencie)
    interesant* s1; 
    interesant* s2;
    //sąsiedzi z lewej i prawej strony w kolejce
};
